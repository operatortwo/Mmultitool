Imports Mmultitool.EventLister
...
Partial Public Class EventListWriter
    ...
    Public Class StatusByteConverter
        ...
        Private ReadOnly Evlistwr As EventListWriter
        Public Sub New(evlw As EventListWriter)
            Evlistwr = evlw
        End Sub
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            If Evlistwr.DesiredStatusFormat = HexOrDec.Hex Then
                Return Hex(value)
            Else
                Return value
            End If
...
#Region "Time to String"
    Public Class TimeToStringConverter
        ...
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            Return ConvertTimeToString(value, Evlistwr.EvliTPQ, Evlistwr.DesiredTimeFormat)
        End Function
